...
public class DataService {
	...
	public String addUser(@RequestBody User user) throws IOException, InterruptedException, ExecutionException {
		...
		InputStream serviceAccount = new FileInputStream("C:\\dev\\projects\\firestore\\service_account\\Users-c44a9454da63.json");
		...
		String output = "Data added to Cloud Firestore: "
